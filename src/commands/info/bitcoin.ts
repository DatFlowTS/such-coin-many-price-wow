...
export default class BitcoinInfoCommand extends Command {
    public constructor() {
        super('bitcoin', {
            aliases: ['bitcoin', 'btc', 'btckurs', 'btcinfo', 'btcrate', 'btcexchange'],
            description: {
                content: 'Shows actual rate of Bitcoin.',
                usage: ''
            },
            category: 'Info',
            channel: 'guild',
    ...
    public async exec(message: Message): Promise<void> {
        ...
        //@ts-ignore
        let lastRateEUR: number = this.client.settings.get('global', 'lastrate.bitcoin.euro', 0);
        //@ts-ignore
        let lastRateDollar: number = this.client.settings.get('global', 'lastrate.bitcoin.dollar', 0);
        ...
        request('https://api.binance.com/api/v3/ticker/price?symbol=BTCEUR', (err1, res1) => {
            ...
            //@ts-ignore
            this.client.settings.set('global', 'lastrate.bitcoin.euro', euroRate);
            ...
            request('https://api.binance.com/api/v3/ticker/price?symbol=BTCUSDT', (err2, res2) => {
                ...
                //@ts-ignore
                this.client.settings.set('global', 'lastrate.bitcoin.dollar', dollarRate);
                rates += "\n$ " + usd;
                ...
                .setAuthor("Bitcoin prices provided by Binance.com", this.client.user.displayAvatarURL({ dynamic: true }), "https://www.binance.com/en/register?ref=UKL9SBW0")
                .setColor(embedColor)
